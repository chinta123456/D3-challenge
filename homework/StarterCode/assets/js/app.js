...
function makeResponsive(x_key=null,y_key=null) {
  ...
  //Get data from data.csv file and turn strings into integers if needed
      ...
      mapping={"Lacks Healthcare (%)":riskData.healthcare,
                "In Poverty (%)":riskData.poverty,
                "Smokers (%)" : riskData.smokes,
                "Average Age": riskData.age,
                "Average income": riskData.income,
                "Abbr": riskData.abbr
            }

//specific features are chosen and transformed here

    //var xkey=(x_key==null)?"Lacks Healthcare (%)":x_key
    //var ykey=(x_key==null)?"Lacks Healthcare (%)":x_key
